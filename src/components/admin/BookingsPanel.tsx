...
import { getBookings, updateBookingStatus, type Booking } from '@/lib/admin-api';
import StatusBadge from './StatusBadge';

const STATUS_OPTIONS: Booking['status'][] = ['new', 'replied', 'booked', 'declined'];
  ...
  return (
    <div>
      ...
      <div className="mb-4 flex items-center gap-4">
        <label htmlFor="booking-status-filter" className="text-sm font-medium text-gray-700">
          Filter by status:
        </label>
        <select
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-sm text-gray-900">
                        ...
                        <div className="text-gray-500 text-xs">
                          <a href={`mailto:${booking.email}`} className="hover:text-orange-600" onClick={e => e.stopPropagation()}>
                            {booking.email}
                          </a>
                        </div>
                      </td>
